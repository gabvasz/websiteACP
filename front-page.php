<?php get_header(); ?>
  ...
  <section class="container py-4 pb-0" id="projetos"">
  ...
  <section class="container py-4" id="sobre">
    ...
    <div class="row align-content-center">
      ...
      <div class="col-lg-6 py-3 d-flex flex-column justify-content-start align-self-center text-dark lead">
        
          <?php the_field('texto-sobre'); ?>

          <a href="<?php echo get_permalink( '107' ); ?>" class="btn btn-outline-primary me-auto">Saiba mais sobre a ACP</a>
  ...
  <section class="container py-4 pb-0 bg-secondary rounded-5 border border-primary border-5 border-start-0 border-bottom-0" id="contribua">
    <div class="row p-3 p-md-5 align-content-center justify-content-center">
      <div class="col-lg-3 d-flex align-items-center justify-content-center mb-4 mb-lg-0">
        <picture class="object-fit-cover">
          <img 
    ...
    <div class="col-lg-6 d-grid align-content-center">
      <h2 class="text-uppercase display-5 text-wrap fw-bold text-light lh-1">contribua <br>com nossos projetos sociais</h2>
  ...
  <section class="container py-4 pb-0" id="blog" >
  ...
  <section class="container py-4 pb-0" id="contato" >
      ...
      <div class="col-md-6 d-flex justify-content-center">
        <div class="col-md-6 d-flex flex-column justify-content-center align-content-center">
          <div class="d-flex align-content-center mb-4 mb-md-0">
            ...
            <a class="btn btn-primary btn-lg align-items-center fw-bold mt-3" href="<?php echo get_field('link-whatsapp') ?>" target="_blank">
